...
functions {
  ...
  #include "/src/stanfiles/functions/BM_functions.stan"
  #include "/src/stanfiles/functions/SEIR_ode_BM.stan"
...
data {
  ...
  #include "/src/stanfiles/data/generic_data.stan"

  // load data objects related to the choosen time dependency
  #include "/src/stanfiles/data/BM_data.stan"
...
transformed data {
  ...
  #include "/src/stanfiles/data/generic_transformed_data.stan"
