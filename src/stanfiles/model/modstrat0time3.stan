...
functions {
  ...
  #include "/src/stanfiles/functions/GP_functions.stan"
  #include "/src/stanfiles/functions/SEIR_ode_GP.stan"
  #include "/src/stanfiles/functions/prevalence_noS.stan" // prevalence function without stratification
}
